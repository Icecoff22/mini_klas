...
public class LectureRegisterService {
    ...
    public int register(LectureRegisterDTO data)
    {
        ...
        String lecturename = targetlecture.getLecturename();
        int lectureidcopy = lectureid;
        User user = check.get();
        ...
        if(coursequota<limit){
            ...
            lectureRegisterRepository.save(new LectureRegisterDTO(user, targetlecture,lecturename, lectureidcopy));
            return 1;//수강신청 성공
        }
